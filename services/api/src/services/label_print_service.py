...
class LabelPrintService:
    ...
    def _compact_snapshot(cls, snapshot: Optional[Dict[str, Any]], code: str) -> Dict[str, Any]:
        ...
        data = {
            ...
            "name_en": name_en,
            "name_ch": name_ch,
            "brand": pick(["brand", "invn006"]),
            "specification": pick(["specification", "spec", "invn051"]),
            "region": pick(["region", "invn030"]),
            "feature": pick(["feature", "invn804", "invn805", "invn803"]),
        ...
        return self._compact_snapshot(
            {
                ...
                "specification": row.get("invn051"),
                "region": row.get("invn030"),
                "feature": row.get("invn804") or row.get("invn805") or row.get("invn803"),
