...
class Conversation(Base):
    ...
    context_version = Column(String(32), nullable=False, default="outdoor-v1", server_default="outdoor-v1")
...
class EdmPreview(Base):
    ...
    table_columns_snapshot = Column(JSONB, nullable=False, default=list)
