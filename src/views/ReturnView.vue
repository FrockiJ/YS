...
const exportSelected = () => {
  ...
  const header = [
    ...
    t('returns.export.columns.specification'),
    t('returns.export.columns.brand'),
    t('returns.export.columns.product'),
    t('returns.export.columns.color'),
    t('returns.export.columns.feature'),
  ...
  const rows = sortedItems.flatMap((quote) => {
    ...
    return quoteItems.map((item) => [
      ...
      resolveQuoteItemValue(item, ['specification'], ''),
      resolveQuoteItemValue(item, ['brand'], ''),
      resolveQuoteItemValue(item, ['product'], ''),
      resolveQuoteItemValue(item, ['color'], ''),
      resolveQuoteItemValue(item, ['feature'], ''),
